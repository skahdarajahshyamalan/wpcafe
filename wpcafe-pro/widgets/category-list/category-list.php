...
class Category_List extends Widget_Base
{
	...
	{
		return esc_html__('WPC Category List Pro', 'wpcafe-pro');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_tab',
			[
				'label' => esc_html__('Category List', 'wpcafe-pro'),
			]
		);
		...
		$this->add_control(
			'food_cat_style',
			[
				'label' => esc_html__('Category Style', 'wpcafe-pro'),
		...
		$this->add_control(
			'category_limit',
			[
				'label' => esc_html__('Category Limit', 'wpcafe-pro'),
				'description'   => esc_html__('Category limit works when category list is not selected', 'wpcafe-pro'),
		...
		$this->add_control(
			'wpc_menu_cat',
			[
				'label' => esc_html__('Category', 'wpcafe-pro'),
		...
		$this->add_control(
			...
			[
				...
				'description'   => esc_html__('Hide empty works when category list is not selected', 'wpcafe-pro'),
